            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="x_panel">
                ...
                <div class="x_title">
                  ...
                  <h2>Add <small>Returned Stock</small></h2>
                ...
                <div class="x_content">
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="addreturnedstock.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="s1" name="sku" required="required" class="form-control col-md-7 col-xs-12" placeholder="Select SKU" onkeyup="search_sku1()" autocomplete="off">
                    ...
                    <!--  </label>-->
                    <!--  <div class="col-md-6 col-sm-6 col-xs-12">-->
                    <!--    <input type="text" id="name" name="name" required="required" class="form-control col-md-7 col-xs-12" readonly="readonly">-->
                    <!--  </div>-->
                    <!--</div>-->
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="unit_price">Returned From <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="return_from" name="return_from" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="unit_price">Reason of Return<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="returned_for" name="return_for" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
