...
?>
					...
					<tr style="display: block; width: 305px;">
                        ...
                        <td><?php echo getInputTextHtml('ncode', $ncode, array('type' => 'number', 'min' => 1, 'max' => 500, 'required' => 'required')); ?></td>
                        <td>
                            <div class="generate" style="float: left"> <input type="submit" value="Generate" /></div>
