...
echo getLocation($real_client_ip_address);
echo $real_client_ip_address = $_ip->getRealIP();
echo $visitor_location       = $_ip->getLocation($real_client_ip_address);

echo $guest_ip   = $visitor_location['IP'];
