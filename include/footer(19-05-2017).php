...
<script src="js/datatables/tools/js/dataTables.tableTools.js"></script> -->
   ...
   if(barcode!='' )
		...
		$("tbody").append("<tr><td>1</td><td>10021</td><td>abc</td><td>1</td><td>5</td><td>200</td><td>200</td></tr>").trigger('create');
        /*$.ajax({url: "demo_test.php?barcode="+barcode, success: function(result){
       ...
       for (var i=0;i<result.length;++i)
        ...
        $.getJSON("demo_test.php?barcode="+barcode, function(result){
        ...
        if(result=="out"){
			...
			alert("This barcode does not exist in database");	
			 $("#search_id").val("");		
		}
        else
        {
      ...
      v = Number(v)+Number(field.price);
     
  cal_total=v.toFixed(2);
     
        $("#total_id").val(cal_total);
        $("#search_id").val("");
        
        $("#amount"+id).val(field.price);
     
     $("#amount"+id).css("background-color", "pink"); 
     
     
     var checkbox = document.getElementById("pro_check"+id);
