<footer>
      <div class="copyright-info">
        ...
        <p class="pull-right">Developed By <a href="http://fingertip.co.in/" target="_blank">Fingertip Consultants Pvt. Ltd</a>  
...
/*
 var handleDataTableButtons = function() {
    ...
    var table = $('#datatable-keytables').DataTable({
       dom: 'Bfrtip',
       buttons: [  {
                extend: 'copyHtml5',
                /*exportOptions: {
...
$(document).ready(function (){
    var table = $('#datatable-brand').DataTable({
       dom: 'Bfrtip',
       buttons: [  {
                extend: 'copyHtml5',
                exportOptions: {
...
$(document).ready(function (){
    var table = $('#datatable-size').DataTable({
       dom: 'Bfrtip',
       buttons: [  {
                extend: 'copyHtml5',
                exportOptions: {
...
$(document).ready(function (){
    var table = $('#datatable-store').DataTable({
       dom: 'Bfrtip',
       buttons: [  {
                extend: 'copyHtml5',
                exportOptions: {
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        var table_stock = $('#datatable-store').DataTable();
        ...
        var select = $('<select><option value="">Select Size</option></select>')
            ...
            .on( 'change', function () {
                ...
                table.column(5)
					...
					$('#totalquantity').html('Quantity:-'+ ' ' + table.column( 8, {page:'current'} ).data().sum()+'<br>Total Quantity:- '+ table.column( 8 ).data().sum());
					...
					$('#totalSalary').html('Price:-'+ ' ' + table.column( 9, {page:'current'} ).data().sum()+ '/-<br>Total Price:- ' +table.column( 9 ).data().sum());
    	...
    	$("#filter_unit").each( function (i) {



        var select = $('<select><option value="">Select Unit</option></select>')
    	...
    	$("#filter_custom").each( function (i) {



        var select = $('<select><option value="">Select Text</option></select>')
...
$.fn.dataTable.ext.search.push(
    ...
    function( settings, data, dataIndex ) {
        ...
        var amount = parseFloat( data[7] ) || 0; // use data for the age column
...
$(document).ready(function() {
  ...
  $('#search-barcode').on('keyup change', function(){
